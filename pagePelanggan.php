<?php
    ...
    header("Location:index.php");
        ...
        $no_meja = isset($auth2['no_meja']) ? $auth2['no_meja'] : '';
        ...
        $data_kd2 = isset($dta3['status_detail']) ? $dta3['status_detail'] : '';
        ...
        $data_kd3 = isset($dta4['status_order']) ? $dta4['status_order'] : '';
                        ...
                        <div class="header__tool">
                            ...
                            <div class="account-wrap">
                                <div class="account-item account-item--style2 clearfix js-item-menu">
                                    <br>
                                    <div class="content">
                                        <a class="js-acc-btn"><?= isset($auth['name']) ? $auth['name'] : '' ?> (<?= isset($auth2['no_meja']) ? $auth2['no_meja'] : '' ?>)
                                        </div>
