<?php
	...
	$no_meja2 = isset($authPelanggan['no_meja']) ? $authPelanggan['no_meja'] : '';
	//For view keranjang
	...
	$data_kd2 = isset($dta3['kd_order']) ? $dta3['kd_order'] : '';
	...
	if ($num > 0) {
	$total     = (int)$dta['total'] + (int)$total;
	$sub_total = (float)$dta['sub_total'] + (float)$sub_total;
